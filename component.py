...
def main():
    ...
    if args.model_name == 'AdaIN':
        ...
        model.load_state_dict(paddle.load("model/AdaIN/model_state.pth"))
        model.to(device)
        ...
        decoder.load_state_dict(paddle.load("model/SANet/decoder_iter_500000.pth"))
        transform.load_state_dict(paddle.load("model/SANet/transformer_iter_500000.pth"))
        vgg.load_state_dict(paddle.load("model/SANet/vgg_normalised.pth"))
    ...
    with paddle.no_grad():
        ...
        for m in id:
            ...
            style_mean = style_mean.view(-1, 512).cpu().numpy()
